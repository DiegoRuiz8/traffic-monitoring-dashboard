...
import IconStatistics from '../../images/icon/icon-statistics.svg';
import IconMainDashboard from '../../images/icon/icon-main-dashboard.svg';
import IconCameraMonitoring from '../../images/icon/icon-camera-monitoring.svg';
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/camerasMonitoring"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('monitoreo') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  {/* Utiliza el ícono importado */}
                  <div className="h-6 w-6">
                    <img
                      src={IconCameraMonitoring}
                      alt="Monitoreo de Cámaras"
